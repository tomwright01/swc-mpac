...
`data/permits_short.csv` dataset containing information about building permits. Can you read the data into R? Can you plot the number of permits issued each year for 
Toronto? Can you calculate the average value of properties by city? 
